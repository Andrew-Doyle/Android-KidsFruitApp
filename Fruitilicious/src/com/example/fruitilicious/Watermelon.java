...
public class Watermelon extends SherlockActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String string_to_change = getResources().getString(R.string.watermelon);
		...
		Drawable bigA = getResources().getDrawable(R.drawable.letter_w);
