...
public class Kiwi extends SherlockActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String string_to_change = getResources().getString(R.string.kiwi);
		...
		final MediaPlayer kiwiSound = MediaPlayer.create(this,
				R.raw.k_for_kiwi);
		...
		Drawable bigA = getResources().getDrawable(R.drawable.letter_k);
