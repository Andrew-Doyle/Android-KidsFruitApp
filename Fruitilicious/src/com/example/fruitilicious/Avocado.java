...
public class Avocado extends SherlockActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String string_to_change = getResources().getString(R.string.avocado);
		...
		final MediaPlayer avocadoSound = MediaPlayer.create(this,
				R.raw.a_for_avocado);
		...
		Drawable bigA = getResources().getDrawable(R.drawable.letter_a);
