...
public class Strawberry extends SherlockActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String string_to_change = getResources().getString(R.string.strawberry);
		...
		Drawable bigA = getResources().getDrawable(R.drawable.letter_s);
