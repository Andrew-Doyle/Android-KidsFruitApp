...
public class Banana extends SherlockActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String string_to_change = getResources().getString(R.string.banana);
		...
		final MediaPlayer bananaSound = MediaPlayer.create(this,
				R.raw.b_for_banana);
		...
		Drawable bigA = getResources().getDrawable(R.drawable.letter_b);
