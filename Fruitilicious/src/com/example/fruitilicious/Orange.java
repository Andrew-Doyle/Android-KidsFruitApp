...
public class Orange extends SherlockActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String string_to_change = getResources().getString(R.string.orange);
		...
		final MediaPlayer orangeSound = MediaPlayer.create(this,
				R.raw.o_for_orange);
		...
		Drawable bigA = getResources().getDrawable(R.drawable.letter_o);
